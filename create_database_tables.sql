-- کوئری‌های MySQL برای ساخت جدول‌های دیتابیس Coinceeper
-- بر اساس ساختار SQLAlchemy models
...
-- اضافه کردن داده‌های پایه برای currencies
INSERT INTO `currencies` (`CurrencyID`, `CurrencyName`, `Icon`, `Symbol`, `BlockchainID`, `DecimalPlaces`, `IsToken`, `CMC_ID`) VALUES
('ETH', 'Ethereum', 'ethereum.png', 'ETH', 1, 18, FALSE, 1027),
('BTC', 'Bitcoin', 'bitcoin.png', 'BTC', 2, 8, FALSE, 1),
('BNB', 'BNB', 'bnb.png', 'BNB', 3, 18, FALSE, 1839),
('MATIC', 'Polygon', 'polygon.png', 'MATIC', 4, 18, FALSE, 3890),
('TRX', 'TRON', 'tron.png', 'TRX', 5, 6, FALSE, 1958),
('AVAX', 'Avalanche', 'avalanche.png', 'AVAX', 6, 18, FALSE, 5805),
('ARB', 'Arbitrum', 'arbitrum.png', 'ARB', 7, 18, FALSE, 11841),
('SOL', 'Solana', 'solana.png', 'SOL', 8, 9, FALSE, 5426),
('XRP', 'XRP', 'xrp.png', 'XRP', 9, 6, FALSE, 52),
('DOT', 'Polkadot', 'polkadot.png', 'DOT', 10, 10, FALSE, 6636);
